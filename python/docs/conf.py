# -*- coding: utf-8 -*-
#
# dlisio documentation build configuration file, created by
...
autodoc_mock_imports = ['dlisio.core']
...
latex_documents = [
  ('index', 'dlisio.tex', u'dlisio Documentation',
   u'Equinor', 'manual'),
]
...
man_pages = [
    ('index', 'dlisio', u'dlisio Documentation',
     [u'Equinor'], 1)
]
...
texinfo_documents = [
  ('index', 'dlisio', u'dlisio Documentation',
   u'Equinor', 'dlisio', 'One line description of project.',
   'Miscellaneous'),
]
